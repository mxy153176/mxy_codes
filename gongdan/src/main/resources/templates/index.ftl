        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 商品系统首页 <small>Amaze UI</small></div>
                    <p class="page-header-description">该系统主要用于管理商品、商家、库存信息</p>
                </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">月度商品进货量</div>
